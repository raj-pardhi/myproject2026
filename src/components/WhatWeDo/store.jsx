...
const Whatwedo = () => {
  ...
  useEffect(() => {
    ...
    // Initial state set करें - सभी text को शुरू में position दें
  ...
  return (
    <div className='w-full text-black   bg-[#ecece4]'>
      ...
      <div className='containerReveal w-full h-screen flex pt-[8rem] pb-[5rem]  justify-center bg-green-300'>
        <div className=' w-full flex items-center flex-col justify-center  '>

          <h1 className='text-[3.5vmax] uppercase font-[clash] leading-9'>Forner is a full-service studio</h1>
          <h3 className='text-[2.5vmax] font-[bigdaily]'>creating brands people love to look at,</h3>
          <div className='flex mb-[1vw] items-center gap-[0.6vw] mt-[1vw]'>
          ...
          <h3 className='text-[2.5vmax] font-[bigdaily] '>listen to and live with.</h3>
      ...
      <div className='block'>
        <div className='pt-[5rem] pb-[12rem]'>
          <div className='flex flex-wrap'>
            ...
            <div className='w-[50%] pr-[10rem] pl-[1rem]  flex items-end justify-end'>

              <div className='weBring relative bg-red-400'>
                <div className='pt-[2rem]'>
                  ...
                  <div className='flex relative text-[3.3vmax] gap-10'>
                    ...
                    <div className='relative'>
                      ...
                      <div className='absolute right-0 top-0 overflow-hidden '>
                        <h3 className='Collatoral'>Collateral</h3>
          ...
          <div className='w-full '>
            <div className='w-full flex  '>
              ...
              <div className='forner-Img2 w-[50%]  '>
                <img className='object-cover w-[15vw]' src="/assets/images/2-22-23_Dr_Rogers_M6890_copy_2sm.webp" alt="" />
              </div>
            </div>


            <div className='w-full flex '>
              <div className='forner-Img3 w-[50%] flex  justify-end  '>
                <img className='object-cover w-[30vw]' src="/assets/images/Newspaper_1.gif" alt="" />
              </div>
            ...
            <div className='w-full flex '>
              <div className='forner-Img4 w-[50%] flex  justify-start '>
                <img className='object-cover w-[10vw]' src="/assets/images/home3.webp" alt="" />
              </div>
            ...
            <div className='w-full flex'>
              <div className='forner-Img5 w-[50%] flex  justify-end '>
                <img className='object-cover w-[10vw]' src="/assets/images/ps.KEE.001_ALL_1027_sm.webp" alt="" />
              </div>
            ...
            <div className='w-full flex '>
              <div className='forner-Img8 w-[50%] flex justify-end '>
                <img className='object-cover w-[32vw]' src="/assets/images/12345.webp" alt="" />
              </div>
